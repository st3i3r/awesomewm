...
local temp = lain.widget.temp({
    settings = function()
widget:set_markup(markup.fontfg(theme.font, "#ffa500", coretemp_now .. "°C"))
end
})
...
vicious.register(volume, vicious.widgets.volume, '<span color="#7493d2">$1%</span>', 0.1, "Master")
...
vicious.register(memwidget, vicious.widgets.mem, '<span color="#e5e500">$2M </span>', 2)
